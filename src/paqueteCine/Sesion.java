...
/**
 * Una clase para representar una sesión
 * @version 	09/05/2021
...
public class Sesion {
	 ...
	 * @param pelicula	- Nombre de la instancia de la clase película que se proyecta.
	 */
	...
	/**
	 * Devuelve una cadena de caracteres que contiene los datos de la sesión y de la película agendada con el siguiente formato:
	 * Sesión:
	...
	/**
	 * Reduce la disponibilidad de butacas en la sesión tras vender un determinado número de entradas.
