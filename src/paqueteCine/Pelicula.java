...
public class Pelicula {
	 ...
	 * @param genero	- Temática general de la película. Está limitado a los géneros ACCION, DRAMA o COMEDIA contenidos en un enumerador.
	 */
	...
	/**
	 * Crea una película sin ningún dato asociado. Los datos se pueden añadir posteriormente usando los métodos de la clase.
	 */
	public Pelicula() {
	}
	...
	/**
	 * Devuelve una cadena de caracteres que lista todos los datos de la película con el siguiente formato:
