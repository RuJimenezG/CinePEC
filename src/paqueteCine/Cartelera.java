 ...
 * Se trata de un ArrayList de objetos de la clase Película.
 * 
 * @version 09/05/2021
...
public class Cartelera {
	...
	/**
	 * Crea una cartelera a partir de una película individual. Posteriormente se
	 * podrán seguir añadiendo más instancias de la clase Pelicula.
	 * 
	 * @param pelicula - Instancia de la clase Pelicula que se quiere añadir al
	 *                 crear la cartelera.
	 */
	 ...
	 * Posteriormente se podrán seguir añadiendo más instancias de la clase
	 * Pelicula.
	 * 
	 * @param lista - Instancia de tipo lista que contiene las películas.
	 */
	 ...
	 * @return Devuelve true si la película buscada está en la cartelera. Si no
	 *         devuelve false.
	 */
	public boolean estaPelicula(String titulo) {
		boolean _encontrada = false;
		if (peliculas.stream().map(pelicula -> pelicula.getTitulo()).anyMatch(t -> t.equals(titulo)) == true) {
			_encontrada = true;
		}
		return _encontrada;
	}
	 ...
	 * Comprueba si ya existe en la cartelera una película con el título indicado.
	 * 
	 * @param pelicula - Instancia de la clase película que se quiere buscar.
	 * @return Devuelve true si la película buscada está en la cartelera. Si no
	 *         devuelve false.
	 */
	 ...
	 * Para cada película del listado se comprueba primero si dicha película no está
	 * ya en el listado. De ser así se añade.
	 * 
	 * @param lista - Instancia de la clase lista que contiene las películas que se
	 *              quieren añadir.
	 * @return Devuelve el valor true si alguna de las películas añadidas no estaba
	 *         ya en la cartelera. En caso contrario devuelve false.
	 */
	public boolean nuevaPelicula(List<Pelicula> lista) {
		...
		for (Pelicula pelicula : lista) {
			if (!estaPelicula(pelicula)) {
				...
				System.out.println("No se ha podido añadir la película " + pelicula.getTitulo()
						+ " porque ya está en la cartelera.\n");
			}
		}
	...
	/**
	 * Añade una nueva película a la cartelera. Primero comprueba que la película
	 * que se quiere añadir no está ya en el listado y de ser así la añade.
	 * 
	 * @param pelicula - Instancia de la clase película que se quiere añadir. No
	 *                 tiene por qué coincidir con el título.
	 * @return Devuelve el valor true si la película que se ha añadido no estaba ya
	 *         en la cartelera. En caso contrario devuelve false.
	 */
	 ...
	 * @return Devuelve el valor true si la película se encontraba en la cartelera y
	 *         ha sido eliminada. En caso contrario devuelve false.
	 */
